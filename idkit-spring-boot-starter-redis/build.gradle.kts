...
mavenPublishing {
    ...
    coordinates("io.github.dornol", "idkit-spring-boot-starter-redis", "$version")
    pom {
        name = "idkit-spring-boot-starter-redis"
        description = "Spring Boot starter for idkit Redis worker identity leases"
